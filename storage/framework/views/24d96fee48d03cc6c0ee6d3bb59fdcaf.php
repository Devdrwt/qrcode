...
<?php $__env->startSection('title', 'Codes Anonymes'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (generateBtn && quantityInput) {
        generateBtn.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch('<?php echo e(route("codes.generate")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Qr-code\resources\views/codes/anonymous.blade.php ENDPATH**/ ?>