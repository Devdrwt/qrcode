...
<?php $__env->startSection('title', 'Vérification QR Code'); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            async function verifyCode(code) {
                try {
                    const response = await fetch('<?php echo e(url('/verify')); ?>', {
                        method: 'POST',
                        headers: {
            ...
            async function markAsUsed(code) {
                try {
                    const response = await fetch('<?php echo e(url('/mark-used')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Qr-code\resources\views/verify/index.blade.php ENDPATH**/ ?>