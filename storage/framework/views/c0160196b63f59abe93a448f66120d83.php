...
<?php $__env->startSection('title', 'Tableau de bord - Codes QR'); ?>
    ...
    <div class="max-w-6xl mx-auto space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-orange-300 rounded-2xl shadow-xl p-6 text-gray-900">
                ...
                <div class="text-4xl font-bold mb-2"><?php echo e($availableCodes); ?></div>
                <div class="h-2 bg-orange-100 rounded-full overflow-hidden">
                    <div class="h-full bg-orange-500" style="width: <?php echo e($availablePercent); ?>%"></div>
                </div>
                <p class="text-xs text-orange-900 mt-2"><?php echo e($availablePercent); ?>% du stock total</p>
            </div>
            <div class="bg-blue-200 rounded-2xl shadow-xl p-6 text-gray-900">
                ...
                <div class="text-4xl font-bold mb-2"><?php echo e($usedCodes); ?></div>
                <div class="h-2 bg-blue-100 rounded-full overflow-hidden">
                    <div class="h-full bg-blue-500" style="width: <?php echo e($usedPercent); ?>%"></div>
                </div>
                <p class="text-xs text-blue-900 mt-2"><?php echo e($usedPercent); ?>% déjà consommés</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
            <a href="<?php echo e(route('codes.anonymous')); ?>"
            ...
            <a href="<?php echo e(route('codes.named')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Qr-code\resources\views/codes/dashboard.blade.php ENDPATH**/ ?>